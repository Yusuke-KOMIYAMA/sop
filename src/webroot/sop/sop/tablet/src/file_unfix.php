...
$rslt = updFileProvisionalUnfix($db, $file_id);
if(!$rslt)
{
...
$history_id = -1;
$rslt = addHistory($db, $history_id, $pj_id, $sop_id, $tpl_id, $schema_id, $file_id, $smpl_given_no, $HISTORY_ACTION_FILE_UNFIX, $date, $user_id, null, null);
if(!$rslt)
{
...
$msg003 = "Cacelleation of the operation complete that wait for the confirmation."; // 作業完了（チェック待ち）を解除しました
echo json_encode(array('success'=>true, 'msg'=> \Sop\Api::htmlEncodeLines(array($msg003))));
exit;
